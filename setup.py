...
setup(
    name="sdeteam",
    version="1.0.0",
    description="SdeTeam: The Multi-Agent Framework",
    ...
    license="MIT",
    keywords="sdeteam multi-agent multi-role programming gpt llm metaprogramming",
    ...
    entry_points={
        "console_scripts": [
            "sdeteam=sdeteam.software_company:app",
        ],
    },
