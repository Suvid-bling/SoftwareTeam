...
from sdeteam.tools import SearchEngineType
    ...
    def _process_extra(
        ...
        **kwargs,
        ...
        if self.engine == SearchEngineType.SERPAPI_GOOGLE:
            ...
            module = "sdeteam.tools.search_engine_bing"
