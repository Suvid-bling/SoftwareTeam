...
from sdeteam.actions.requirement_analysis.framework import (
    EvaluateFramework,
    WriteFramework,
    save_framework,
)
from sdeteam.actions.requirement_analysis.trd import (
    CompressExternalInterfaces,
    DetectInteraction,
    EvaluateTRD,
    WriteTRD,
)
from sdeteam.const import ASSISTANT_ALIAS, TEST_DATA_PATH
from sdeteam.context import Context
from sdeteam.logs import ToolLogItem, log_tool_output, logger
from sdeteam.utils.common import aread
...
async def import_git_repo(url: str) -> Path:
    ...
    """
    from sdeteam.actions.import_repo import ImportRepo
    from sdeteam.context import Context
