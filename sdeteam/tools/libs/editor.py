...
from sdeteam.const import DEFAULT_MIN_TOKEN_COUNT, DEFAULT_WORKSPACE_ROOT
from sdeteam.tools.libs.linter import Linter
from sdeteam.tools.tool_registry import register_tool
from sdeteam.utils.common import awrite
...
class Editor(BaseModel):
    ...
    async def similarity_search(query: str, path: Union[str, Path]) -> List[str]:
        ...
        """
        try:
            from sdeteam.tools.libs.index_repo import IndexRepo
