...
from sdeteam.actions import Action, UserRequirement
from sdeteam.actions.di.run_command import RunCommand
from sdeteam.actions.search_enhanced_qa import SearchEnhancedQA
from sdeteam.exp_pool import exp_cache
from sdeteam.exp_pool.context_builders import RoleZeroContextBuilder
from sdeteam.exp_pool.serializers import RoleZeroSerializer
from sdeteam.logs import logger
from sdeteam.memory.role_zero_memory import RoleZeroLongTermMemory
from sdeteam.prompts.di.role_zero import (
    CMD_PROMPT,
...
from sdeteam.schema import AIMessage, Message, UserMessage
from sdeteam.strategy.experience_retriever import DummyExpRetriever, ExpRetriever
from sdeteam.strategy.planner import Planner
from sdeteam.tools.libs.browser import Browser
from sdeteam.tools.libs.editor import Editor
from sdeteam.tools.tool_recommend import BM25ToolRecommender, ToolRecommender
from sdeteam.tools.tool_registry import register_tool
from sdeteam.utils.common import any_to_str
from sdeteam.utils.report import ThoughtReporter
from sdeteam.utils.role_zero_utils import (
    check_duplicates,
...
class RoleZero(Role):
    ...
    async def ask_human(self, question: str) -> str:
        ...
        from sdeteam.environment.mgx.mgx_env import MGXEnv  # avoid circular import
