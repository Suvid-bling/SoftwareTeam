...
from sdeteam.const import SDETEAM_REPORTER_DEFAULT_URL
from sdeteam.logs import create_llm_stream_queue, get_llm_stream_queue

if typing.TYPE_CHECKING:
    from sdeteam.roles.role import Role
...
class ResourceReporter(BaseModel):
    ...
    callback_url: str = Field(SDETEAM_REPORTER_DEFAULT_URL, description="The URL to which the report should be sent")
