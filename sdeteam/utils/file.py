...
from sdeteam.utils import read_docx
from sdeteam.utils.common import aread, aread_bin, awrite_bin, check_http_endpoint
from sdeteam.utils.exceptions import handle_exception
from sdeteam.utils.repo_to_markdown import is_text_file
...
class File:
    ...
    async def _omniparse_read_file(path: Union[str, Path], auto_save_image: bool = False) -> Optional[str]:
        from sdeteam.tools.libs import get_env_default
        from sdeteam.utils.omniparse_client import OmniParseClient
