...
from sdeteam.actions import UserRequirement
from sdeteam.const import TEAMLEADER_NAME
from sdeteam.logs import logger
from sdeteam.memory import Memory
from sdeteam.schema import LongTermMemoryItem, Message
...
class RoleZeroLongTermMemory(Memory):
    ...
    def _resolve_rag_engine(self) -> "SimpleEngine":
        ...
        try:
            from sdeteam.rag.engines import SimpleEngine
            from sdeteam.rag.schema import ChromaRetrieverConfig, LLMRankerConfig
        except ImportError:
