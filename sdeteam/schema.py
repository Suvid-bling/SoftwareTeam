...
from sdeteam.base.base_serialization import BaseSerialization
from sdeteam.const import (
    AGENT,
...
from sdeteam.repo_parser import DotClassInfo
...
from sdeteam.utils.report import TaskReporter
from sdeteam.utils.serialize import (
...
class Message(BaseModel):
    ...
    def check_instruct_content(cls, ic: Any) -> BaseModel:
        if ic and isinstance(ic, dict) and "class" in ic:
            if "mapping" in ic:
                ...
                actionnode_class = import_class("ActionNode", "sdeteam.actions.action_node")  # avoid circular import
    ...
    def check_cause_by(cls, cause_by: Any) -> str:
        return any_to_str(cause_by if cause_by else import_class("UserRequirement", "sdeteam.actions.add_requirement"))
