...
from sdeteam.const import CONFIG_ROOT
...
def startup(
    ...
    init_config: bool = typer.Option(default=False, help="Initialize the configuration file for SdeTeam."),
):
    ...
    if idea is None:
        typer.echo("Missing argument 'IDEA'. Run 'sdeteam --help' for more information.")
        raise typer.Exit()
...
DEFAULT_CONFIG = """# SdeTeam Configuration
...
def copy_config_to():
    """Initialize the configuration file for SdeTeam."""
